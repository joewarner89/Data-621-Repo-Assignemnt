...
#### 3.1.2 Model 2: Stepwise Selection

This technique allows automatic inclusion or exclusion of variables based on AIC (Akaike Information Criterion). It provides a good way to identify the most important predictors while reducing model complexity.

```{r}
# Multiple Linear Regression - Model 2 (Stepwise Selection)
model2 <- lm(TARGET_AMT_LOG ~ ., data = insurance_training)
step_model2 <- step(model2, direction = "both")
summary(step_model2)
```
