...
money_ball_interaction <- money_ball %>%
  mutate(
...
model_interaction <- lm(TARGET_WINS ~ TEAM_BATTING_H + TEAM_BATTING_2B + TEAM_BATTING_3B +
                        TEAM_BATTING_HR + TEAM_BATTING_BB + TEAM_BATTING_SO +
                        TEAM_BASERUN_SB + TEAM_BASERUN_CS +
                        TEAM_PITCHING_H + TEAM_PITCHING_HR + TEAM_PITCHING_BB + TEAM_PITCHING_SO +
                        TEAM_FIELDING_E + TEAM_FIELDING_DP +
                        interaction_HR_BB + interaction_Pitching_HR_BB + interaction_Fielding_E_DP,
                      data = money_ball_interaction)
...
money_ball_interaction <- money_ball_clean %>%
  mutate(
...
# Fit a linear regression model with interaction terms
model_interaction <- lm(TARGET_WINS ~ interaction_BATTING + interaction_PITCHING +
