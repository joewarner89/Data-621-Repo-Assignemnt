...
####    2.2.1. Understanding the Confusion Matrix Output

The confusion matrix is formatted as follows:
...
# Plot the ROC curve with correct x-axis (1 - specificity)
plot(1 - roc_result$specificities, roc_result$sensitivities, type = "l", 
     col = "blue", lwd = 2, xlab = "1 - Specificity (False Positive Rate)", 
     ylab = "Sensitivity (True Positive Rate)", main = "ROC Curve with AUC")
...
#### 13.2.2. Plot the Gain and Lift Charts
...
# Highlight the Area Under the Curve (AUC)
auc_value <- auc(roc_obj)
polygon(c(0, 1 - roc_obj$specificities, 1), c(0, roc_obj$sensitivities, 0), col = rgb(0, 0, 1, 0.2), border = NA)
